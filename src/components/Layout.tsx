                        ...
                        <div class="pt-4 border-t border-base-300">
                            ...
                            <div class="flex items-center gap-2 px-1 flex-wrap">
                                ...
                                <a
                                    ...
                                    data-tip="X (Twitter)"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" style="fill: #000000" aria-label="X">
                                ...
                                <a
                                    ...
                                    data-tip="Misskey"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" style="fill: #86B300" aria-label="Misskey">
                                ...
                                <a
                                    ...
                                    data-tip="Bluesky"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" style="fill: #0085ff" aria-label="Bluesky">
                                ...
                                <a
                                    ...
                                    data-tip="Mastodon"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5" style="fill: #6364ff" aria-label="Mastodon">
